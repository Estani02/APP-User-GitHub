      ...
      <div className='md:flex md:flex-col gap-6'>
        ...
        <article className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 mt-4'>
          ...
          <div className='flex flex-row items-center gap-2'>
            ...
            <a href={user.html_url} target='_blank' className='mr-2 truncate text-white'>{user.html_url}</a>
          </div>
          <div className='flex flex-row items-center gap-2'>
            <TwitterIcon className='fill-white' />
            <span className={`mr-2 truncate ${user.twitter_username ? 'text-white' : 'text-gray-400'}`}>{user.twitter_username ? user.twitter_username : "Not Available"}</span>
          </div>
          <div className='flex flex-row items-center gap-2'>
