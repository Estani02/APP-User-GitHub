  ...
  return (
    <form onSubmit={handleSubmit} className='p-2 bg-white shadow-md dark:shadow-none dark:bg-[#202A49] rounded-lg flex flex-row items-center justify-center gap-2 md:h-[3.5rem] lg:h--[4.5rem] w-full md:max-w-[700px] mt-6'>
      ...
      <input
        ...
        value={input}
        name='username'
        className='outline-none bg-transparent dark:text-white flex-1 h-full appearance-none focus:outline-none focus:bg-transparent'
      ...
      <button
        type='submit'
        disabled={disabled}
        className={`rounded-lg ${disabled ? 'bg-[#0077ff54] text-gray-500 dark:text-[#ffffff4c]' : 'bg-[#0079FF] text-white hover:bg-[#0077ffc1]'}  p-1 md:p-2 lg:p-3  transition-color duration-300 font-semibold`}
      >
        Search
      </button>
    </form>
